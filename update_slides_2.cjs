...
const newSlides = `  const slides = [
    ...
    { img: '/cinematic_1b.jpg', text: 'Nhóm Mạch Nối tự hào trình diễn bản Demo tâm huyết của mình trước hội đồng.' },
    { img: '/cinematic_2.jpg', text: '19:50. Lỗi 404.\\nBản Demo đột ngột biến mất khỏi hệ thống...' },
    { img: '/cinematic_23.jpg', text: 'Một tin nhắn báo tin dữ từ Nam:\\n"Tôi không làm tiếp nữa..."' },
