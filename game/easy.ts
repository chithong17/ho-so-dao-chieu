...
export const easyEvidence:Evidence[] = [
 ...
 {id:'EZ03',chapter:1,title:'Trước khi mất mạng',author:'Quân · phụ trách kiểm thử',time:'Ngày D · 18:10–19:45',order:1810,app:'files',summary:'Các mốc ghi nhận khi thay yêu cầu, chạy thử và mất kết nối.',body:[
...
export const easyCounterpoints:Record<string,{speaker:string;role:string;evidence:string;message:string}> = {
 ...
 N2:{speaker:'Quân',role:'Phụ trách kiểm thử',evidence:'EZ03',message:'“Hãy so sánh thời điểm lần thử thất bại với thời điểm mất mạng. Nhận định của bạn đã giải thích được thứ tự này chưa?”'},
 N3:{speaker:'Quân',role:'Phụ trách kiểm thử',evidence:'EZ04',message:'“Hãy xem cả trường hợp khác biệt và cách bạn nối các thông tin thành một lời giải thích.”'},
