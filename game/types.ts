...
export type Task = { id: string; chapter: Chapter; concept: ConceptId; title: string; prompt: string; evidence: string[]; hints: [string,string]; kind: Answer['kind']; questions?: Question[]; criteria: [string,string,string,string]; feedback: [string,string,string,string] };
export type Answer =
...
export type GameState = {
 schemaVersion: 1; caseVersion: '1.1.0'; caseId: 'HS-01'; mode: Mode;
